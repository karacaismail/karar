    ...
    pages: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'callout', kind: 'case', title: 'Vaka: NUMMI — aynı işçiler, yeni sistem', text: 'Kaizen\'in "sorun işçide değil sistemde" iddiasının en ünlü kanıtı NUMMI\'dir. GM\'in Fremont fabrikası 1982\'de kapatıldığında şirketin en sorunlu tesislerinden biri olarak biliniyordu: düşük kalite, yüksek devamsızlık, sert işçi-yönetim gerginliği. 1984\'te Toyota ile GM fabrikayı NUMMI adıyla ortak girişim olarak yeniden açtı ve büyük ölçüde AYNI işçileri geri işe aldı — ama bu kez Toyota\'nın sistemiyle: kaizen önerileri, andon ipi, ekip çalışması, hattı durdurma yetkisi. Birkaç yıl içinde fabrika GM ağının en kalitelilerinden biri haline geldi; vaka Harvard ve MIT araştırmalarında, John Shook gibi tanıkların anlatımlarında belgelendi. İnsanlar değişmedi; sistem değişti.' },
          { t: 'h2', text: 'Gerçek fayda' },
          { t: 'ul', items: [
    ...
    pages: [
      {
        ...
        blocks: [
          ...
          { t: 'h2', text: 'Sigma seviyeleri: gerçek hata oranları' },
          { t: 'table', head: ['Sigma seviyesi', 'Milyonda hata (DPMO)', 'Başarı oranı', 'Günlük hayattan karşılığı'], rows: [
            ['2 sigma', '308.538', 'Yüzde 69,1', 'Yüz mektubun 31\'i yanlış adrese'],
            ['3 sigma', '66.807', 'Yüzde 93,3', 'Sıradan bir işletmenin tipik seviyesi'],
            ['4 sigma', '6.210', 'Yüzde 99,38', 'Bin siparişin 6\'sı hatalı'],
            ['5 sigma', '233', 'Yüzde 99,977', 'On bin işlemde 2-3 hata'],
            ['6 sigma', '3,4', 'Yüzde 99,99966', 'Bir milyon işlemde yalnızca 3-4 hata'],
          ]},
          { t: 'p', text: 'Tablo, metodolojinin standart DPMO (milyon fırsatta hata) değerleridir. Fark katlanarak büyür: 3 sigmadan 6 sigmaya çıkmak hatayı yüzde birkaç azaltmak değil, YİRMİ BİN KAT azaltmaktır. Havayolu bagajı 3-4 sigma civarında çalışır ama uçuş güvenliği 6 sigmanın da ötesindedir — hangi sürecin kaç sigmaya ihtiyacı olduğu da bir yönetim kararıdır.' },
