    ...
    pages: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'callout', kind: 'case', title: 'Vaka: Jobs\'un 1997 "hayır" dönüşü', text: 'Steve Jobs 1997\'de batmakta olan Apple\'a döndüğünde şirket onlarca ürün modeli üretiyordu. Jobs ürün gamını dört hücreli tek bir tabloya indirdi (masaüstü/taşınabilir × tüketici/profesyonel) ve geri kalan her şeye hayır dedi; yazıcılar ve Newton dahil ürünlerin büyük kısmı kapatıldı. Aynı yıl WWDC konferansında bunu açıkça söyledi: "Odaklanmak, yüzlerce iyi fikre hayır demektir." Apple iki yıl içinde yeniden kâra geçti. Kural aynı kuraldır: kesin evet olmayan her şey — iyi fikir bile olsa — hayırdır.' },
          { t: 'h2', text: 'Gerçek fayda' },
          { t: 'ul', items: [
