...
import { section9Models } from './section9'
...
export const newSlugs: Set<string> = new Set(
  [...section5aModels, ...section5bModels, ...section5cModels, ...section6aModels, ...section6bModels, ...section7aModels, ...section7bModels, ...section7cModels, ...section8aModels, ...section8bModels, ...section8cModels, ...section9Models].map((m) => m.slug),
)
